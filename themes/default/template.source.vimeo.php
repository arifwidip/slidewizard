...
<div class="slide-image vimeo-video-cover">
  <div class="vimeo-video-iframe">
    <?php echo $video_embed; ?>
  </div>
  <div class="vimeo-video-thumbnail">
    <img src="<?php echo $image; ?>">
  </div>
  <a class="play-vimeo-video" data-video-id="<?php echo $id; ?>"></a>
</div>
